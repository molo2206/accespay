...
export class AuthServiceService {
          ...
          try {
            await this.mailService.sendHtmlEmail(
              ...
              'otp-email.html',
              {
                ...
                copyright: this.i18nService.translate(
                  'email_otp_copyright',
                  lang,
          ...
          await this.mailService.sendHtmlEmail(
            ...
            'welcome-email.html',
            {
              ...
              credentials_label: this.i18nService.translate(
                'email_welcome_credentials',
                lang,
              ),
              phone_label: this.i18nService.translate(
                'email_welcome_phone',
                lang,
                { phone: user.phone },
              ),
              account_label: this.i18nService.translate(
                'email_welcome_account',
                lang,
                { account_number: user.account_number },
              ),
              password_label: this.i18nService.translate(
                'email_welcome_password',
                lang,
  ...
  async login(
    ...
    try {
      ...
      return { ...result, sessionId, resources };
    } catch (error) {
      if (
